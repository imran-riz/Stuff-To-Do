...
public class NewTaskFormController {
    ...
    public void addNewTask() {
        ...
        if (taskText.isBlank() || taskDueDate == null || taskReminderDate == null || reminderHr.equals("--") || reminderMin.equals("--") || reminderDayPeriod.equals("--")) {
            ...
            while (TaskCollection.getInstance().getTask(taskId) != null);
            ...
            if (HomePageController.headerTxt.getValue().equalsIgnoreCase("Planned")) {
                HomePageController.addTaskToListView(task);
            }
